...
function PreNavbar() {
    return (
        <div className="preNav">
            <div>
                <Link to="/miindia">MI INDIA</Link> <span>|</span>
                <Link to="/storeapp">GET MI STORE APP</Link> <span>|</span>
                <Link to="/help">ONLINE HELP</Link> <span>|</span>
                <Link to="retailstore">RETAIL STORE ﹀</Link>
            </div>
            <div>
                <Link to="/signin">SIGN IN</Link> <span>|</span>
                <Link to="/signup">SIGN UP</Link> <span>|</span>
                <Link to="/cart{0}"> {cartIcon} CART (0)</Link>
